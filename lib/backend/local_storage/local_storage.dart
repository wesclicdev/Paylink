...
const String appBasicLogoKey = "appBasicLogoKey";

const String appBasicIconKey = "appBasicIconKey";
...
class LocalStorage {
  ...
  static Future<void> appBasicLogo({required String logo}) async {
    final box = GetStorage();

    await box.write(appBasicLogoKey, logo);
  }

  static Future<void> appBasicIcon({required String logoIcon}) async {
    final box = GetStorage();

    await box.write(appBasicIconKey, logoIcon);
  }
  ...
  static String getAppBasicLogo() {
    return GetStorage().read(appBasicLogoKey);
  }
  static String getAppBasicIcon() {
    return GetStorage().read(appBasicIconKey);
  }
  //ss
