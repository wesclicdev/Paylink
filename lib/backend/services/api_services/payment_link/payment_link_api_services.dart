...
class PaymentLinkApiServices {
  ///* get Payment Link process api
  static Future<PaymentLinkModel?> getPaymentLinkProcessApi() async {
  ...
  static Future<PaymentLinkStoreModel?> paymentLinkStoreWithoutImageApi(
  ...
  static Future<PaymentLinkStoreModel?> paymentLinkStoreWithImageApi(
  ...
  static Future<CommonSuccessModel?> updatePaymentLinkStatusApi(
      {required Map<String, dynamic> body}) async {
    Map<String, dynamic>? mapResponse;
    try {
      mapResponse = await ApiMethod(isBasic: false)
  ...
  static Future<PaymentLinkEditModel?> getPaymentEditLinkProcessApi(
      int target) async {
    Map<String, dynamic>? mapResponse;
    try {
      mapResponse = await ApiMethod(isBasic: false).get(
  ...
  static Future<PaymentLinkUpdateModel?> updatePaymentWithImageApi(
      {required Map<String, String> body, required dynamic filepath}) async {
    Map<String, dynamic>? mapResponse;
    try {
      mapResponse = await ApiMethod(isBasic: false).multipart(
  ...
  static Future<PaymentLinkUpdateModel?> updatePaymentWithoutImageApi(
      {required Map<String, dynamic> body}) async {
    Map<String, dynamic>? mapResponse;
    try {
      mapResponse = await ApiMethod(isBasic: false)
      ...
      if (mapResponse != null) {
        PaymentLinkUpdateModel result = PaymentLinkUpdateModel.fromJson(mapResponse);
        CustomSnackBar.success(result.message.success.first.toString());
        return result;
      }
    } catch (e) {
