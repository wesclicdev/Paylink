...
class PaymentsEditController extends GetxController {
  ...
  get onEditTap => Routes.paymentsEditScreen.toNamed;
  ...
  Future<PaymentLinkEditModel> getPaymentLinkEditProcess() async {
    ...
    update();
    await PaymentLinkApiServices.getPaymentEditLinkProcessApi(
  ...
  Future<PaymentLinkUpdateModel> paymentLinkUpdateWithImageProcess() async {
    ...
    await PaymentLinkApiServices.updatePaymentWithImageApi(
  ...
  Future<PaymentLinkUpdateModel> paymentLinkUpdateWithOutImageProcess() async {
    ...
    await PaymentLinkApiServices.updatePaymentWithoutImageApi(
      body: typeSelection.value == DynamicLanguage.key(Strings.customerChoose)
          ? payInputBody
          : subInputBody,
    ).then((value) {
